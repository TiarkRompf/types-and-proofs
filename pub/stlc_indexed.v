...
Proof.
  ...
  remember (teval (n-nf-nx) (vx :: l) t0) as ty. symmetry in Heqty. destruct ty as [ny [ry|]]. 2: inversion EV.
...
Proof.
  ...
  - simpl. destruct n; simpl. eauto. intros.
    ...
    eapply envt_dec. eauto. 2: eauto. lia. eauto.
    eexists. eapply H3. 
Qed.
