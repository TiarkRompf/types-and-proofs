...
Inductive eq_type : kenv -> ty -> ty -> Type :=
| q_refl: forall J T,
    eq_type J T T
...
Proof.
  ...
  - dependent destruction H. constructor; auto. specialize (IHT2 J (k :: J') T1 K1 KTpe). apply IHT2; auto. simpl. rewrite splice_acc in H. auto.
...
Proof.
  ...
  - split; intros; dependent destruction H.
    apply k_tapp with (K1 := K1). specialize (IHheq1 (KArr K1 K2)); destruct IHheq1. auto. specialize (IHheq2 K1); destruct IHheq2; auto.
    apply k_tapp with (K1 := K1). specialize (IHheq1 (KArr K1 K2)); destruct IHheq1. auto. specialize (IHheq2 K1); destruct IHheq2; auto.
  - split; intros.
...
Proof.
  ...
  - dependent destruction h1. dependent destruction h2. simpl. f_equal.
    ...
    specialize (IHeq_type (envkv_cons J K1 x WFJ) KTpe h1 h2). auto.
